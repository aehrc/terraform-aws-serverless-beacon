...
def lambda_handler(event, context):
    ...
    if event["resource"] == "/biosamples":
        ...
        return route_biosamples_id(request_params, event["pathParameters"].get("id", None))

    elif event['resource'] == '/biosamples/{id}/g_variants':
        return route_biosamples_id_g_variants(request_params, event["pathParameters"].get("id", None))

    elif event['resource'] == '/biosamples/{id}/analyses':
        return route_biosamples_id_analyses(request_params, event["pathParameters"].get("id", None))

    elif event['resource'] == '/biosamples/{id}/runs':
        return route_biosamples_id_runs(request_params, event["pathParameters"].get("id", None))
