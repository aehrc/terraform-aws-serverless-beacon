...
def lambda_handler(event, context):
    ...
    if event["resource"] == "/runs":
        ...
        return route_runs_id_g_variants(request_params, event["pathParameters"].get("id", None))

    elif event['resource'] == '/runs/{id}/analyses':
        return route_runs_id_analyses(request_params, event["pathParameters"].get("id", None))
