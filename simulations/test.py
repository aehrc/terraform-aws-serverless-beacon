...
# complex query terms
query_terms = [
    {"id": random.choice(dataset_terms), "scope": "datasets"},
    {"id": random.choice(individual_terms), "scope": "individuals"},
    {"id": random.choice(biosample_terms), "scope": "biosamples"},
    {"id": random.choice(run_terms), "scope": "runs"},
    {"id": random.choice(cohort_terms), "scope": "cohorts"},
]
